...
parser.add_argument('--save_path', help='training file', default='/home/data/tmp/NLP_Course/TextBERT_multi_GPU/train')
parser.add_argument('--train_file', help='training file', default='/home/data/tmp/NLP_Course/TextBERT_multi_GPU/data/train')
parser.add_argument('--valid_file', help='valid file', default='/home/data/tmp/NLP_Course/TextBERT_multi_GPU/data/test')
...
try:
    ...
    model = BertForSequenceClassification.from_pretrained(args.bert_path, config=bert_config).to(device)
