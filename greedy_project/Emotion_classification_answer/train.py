...
parser.add_argument('--save_path', help='training file', default='/home/data/tmp/NLP_Course/Emotion_classification_answer/train')
parser.add_argument('--train_file', help='training file', default='/home/data/tmp/NLP_Course/Emotion_classification_answer/data/train')
parser.add_argument('--valid_file', help='valid file', default='/home/data/tmp/NLP_Course/Emotion_classification_answer/data/test')
